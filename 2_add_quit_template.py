...
def print_options():
    ...
    print('2 - Paper')
    print('3 - Scissors')
    # Add another line to the player's options that tells them how to quit the program
...
if __name__ == '__main__':
    ...
    while playing_game:
        ...
        elif human_choice == your_code:  # todo <-- Replace the your_code with the conditional
            # If the human wants to quit the game, let's exit out by setting the "playing_game" variable to False
            your_code  # todo <-- Your code here
